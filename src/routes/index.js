...
router.use('/api/v1/reports', require('./reportRoutes'));
...
router.get('/manager/statistics',auth.protect, auth.restrictTo('admin','manager'), managerController.renderStatistics);
